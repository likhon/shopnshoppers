                ...
                <div class="post-preview">
                    ...
                    <div class="image">
                        <?php if($post["first_image"]) { ?>
                            <img class="img-responsive img-rounded product-retina" data-image2x="<?php echo $post["first_image2x"]; ?>" src="<?php echo $post["first_image"]; ?>" alt="post image blog_posts" />
