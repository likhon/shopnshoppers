...
<?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <div class="cart-info table shopping-cart-table">
      <table>
        <thead>
          <tr>
            <td class="image image_table_title"><?php echo $column_image; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="quantity">
                <span class="cart-col-name" style="line-height: 30px"><?php echo $column_quantity; ?>:</span>
                <input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="4" />

                &nbsp;
              <input type="image" class="product-retina" style="width:16px;height:16px" src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/update.png" data-image2x="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/update_r.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />

                &nbsp;
                <a class="flaticon-garbage9" href="<?php echo $product['remove']; ?>"></a>
            </td>
            <td class="price">
            ...
            <td class="total">
                <span class="cart-col-name"><?php echo $column_total; ?>:</span>
