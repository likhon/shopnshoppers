          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="latest_module[<?php echo $module_row; ?>][position]">
                      <?php if ($module['position'] == 'column_right_filter') { ?>
                      <option value="column_right_filter" selected="selected">Main Page Isotope Filter</option>
                      <?php } else { ?>
                      <option value="column_right_filter">Main Page Isotope Filter</option>
                      <?php } ?>
...
function addModule() {	
    ...
    html += '      <option value="column_right_filter">Main Page Isotope Filter</option>';
